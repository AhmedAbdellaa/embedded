...
void CLCD_VoidInit(void){
	//0-set port direction to output
	#if CLCD_u8CONNECTION_MODE ==  EIGHT_BIT
		DIO_u8_SetPortDir(CLCD_u8DATA_PORT,0xff);
		DIO_u8_SetPinDir(CLCD_u8CTRL_PORT, CLCD_u8RS_PIN,DIO_PIN_OUTPUT);
		DIO_u8_SetPinDir(CLCD_u8CTRL_PORT, CLCD_u8RW_PIN,DIO_PIN_OUTPUT);
		DIO_u8_SetPinDir(CLCD_u8CTRL_PORT, CLCD_u8E_PIN,DIO_PIN_OUTPUT);

	#elif CLCD_u8CONNECTION_MODE ==  FOUR_BIT
		DIO_u8_SetPinDir(CLCD_u8CTRL_PORT, CLCD_u8RS_PIN,DIO_PIN_OUTPUT);
		DIO_u8_SetPinDir(CLCD_u8CTRL_PORT, CLCD_u8E_PIN,DIO_PIN_OUTPUT);

		DIO_u8_SetPinDir(CLCD_u8DATA_PORT, CLCD_u8D4_PIN,DIO_PIN_OUTPUT);
		DIO_u8_SetPinDir(CLCD_u8DATA_PORT, CLCD_u8D5_PIN,DIO_PIN_OUTPUT);
		DIO_u8_SetPinDir(CLCD_u8DATA_PORT, CLCD_u8D6_PIN,DIO_PIN_OUTPUT);
		DIO_u8_SetPinDir(CLCD_u8DATA_PORT, CLCD_u8D7_PIN,DIO_PIN_OUTPUT);
	#endif
...
void CLCD_VoidPrintChars(uint8* copy_u8charArray){
